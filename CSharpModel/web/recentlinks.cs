...
namespace GeneXus.Programs {
   public class recentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20221128032425", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?20221128032425", false, true);
         }
